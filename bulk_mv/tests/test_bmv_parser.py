    ...
    def test_file_tree_visitor(self):
        ...
        expected_output = {
            "add": [
                "web/assets/",
                "web/pages/images/",
                "web/pages/images/profile_photos/"
            ],
            "delete": [
                "web/pages/images/delete_me.jpg"
            ],
            "rename_files": [
                {
                    "old_path": "web/static/main.css",
                    "new_path": "web/static/script.css"
                },
                {
                    "old_path": "web/static/main.js",
                    "new_path": "web/static/script.js"
                }
            ],
            "rename_dirs": [],
            "move_files": [
                {
                    "current_path": "web/pages/images/photo.jpg",
                    "new_path": "web/pages/images/profile_photos"
                }
            ],
            "move_dirs": [
                {
                    "current_path": "web/static/",
                    "new_path": "web/assets"
                }
            ]
        }
